    ...
    try{
      ...
      switch (action) {
        ...
        case "createPets": {
          ...
          JsonObject params = context.getParams();
          try {
            service.createPets(ApiHandlerUtils.searchOptionalJsonObjectInJson(params, "pet").map(j -> new model.Pet(j)).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "listPetsSecurity": {
          ...
          JsonObject params = context.getParams();
          try {
            service.listPetsSecurity(context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
                                msg.reply(res.cause());
        ...
        case "encodedParamTest": {
          ...
          JsonObject params = context.getParams();
          try {
            service.encodedParamTest(context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
                                msg.reply(res.cause());
